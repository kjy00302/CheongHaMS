package com.kimjio.cheongha.ms.widget;
...
import com.kimjio.cheongha.ms.tool.ProcessTask;
    ...
    static void updateSmallAppWidget(Context mContext, AppWidgetManager appWidgetManager, int appWidgetId, boolean ifNotUpdate) {
        ...
        if (mData.isBlankDay) {
            ...
            if (hour <= 13) {
                ...
                mTitle = mContext.getString(R.string.tomorrow_lunch);
                mTodayMeal = mData.LunchTomorrow;
                if (BapTool.mStringCheck(mTodayMeal)) {
                    mTodayMeal = mContext.getString(R.string.no_data_lunch_tomorrow);
                } else {
                    mTodayMeal = BapTool.replaceString(mTodayMeal);
                }
            }
    ...
    static void updateLargeAppWidget(Context mContext, AppWidgetManager appWidgetManager, int appWidgetId, boolean ifNotUpdate) {
        ...
        if (mData.isBlankDay) {
            ...
            if (Tools.isOnline(mContext)) {
                ...
                if (new Preference(mContext).getBoolean("updateWiFi", true) && !Tools.isWifi(mContext)) {
                    mViews.setTextViewText(R.id.mLunch, mContext.getString(R.string.widget_no_data));
                    mViews.setTextViewText(R.id.mLunchTomorrow, mContext.getString(R.string.widget_no_data));
            ...
            String mLunchTomorrow = mData.LunchTomorrow;
            ...
            if (BapTool.mStringCheck(mLunchTomorrow)) {
                mLunchTomorrow = mContext.getString(R.string.no_data_lunch_tomorrow);
            } else {
                mLunchTomorrow = BapTool.replaceString(mLunchTomorrow);
            }
            ...
            mViews.setTextViewText(R.id.mLunchTomorrow, mLunchTomorrow);
