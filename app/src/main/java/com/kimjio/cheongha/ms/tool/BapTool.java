...
public class BapTool {
    ...
    public static final int TYPE_LUNCH_Tomorrow = 2;
    ...
    public static boolean canPostStar(Context mContext, int type) {
        ...
        return mPref.getBoolean(lunchKey, true);
    }
    ...
    public static restoreBapDateClass restoreBapData(Context mContext, int year, int month, int day) {
        ...
        String mPrefLunchName = getBapStringFormat(year, month, day, TYPE_LUNCH);
        String mPrefLunchTomorrowName = getBapStringFormat(year, month, day + 1, TYPE_LUNCH);
        //String mPrefDinnerName = getBapStringFormat(year, month, day, TYPE_DINNER);

        Log.i("mPrefLunchTomorrowName", "" + mPrefLunchTomorrowName);
        Log.i("mPrefLunchName", "" + mPrefLunchName);
        ...
        mData.LunchTomorrow = mPref.getString(mPrefLunchTomorrowName, null);
