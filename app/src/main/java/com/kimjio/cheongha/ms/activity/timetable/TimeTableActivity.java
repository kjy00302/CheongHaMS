...
public class TimeTableActivity extends AppCompatActivity implements FABProgressListener  {
    Preference mPref;
    ViewPager viewPager;
    ...
    private void downloadStartFab() {
        new File(TimeTableTool.mFilePath + TimeTableTool.TimeTableDBName).delete();
        DBDownloadTaskFab mTask = new DBDownloadTaskFab();
        mTask.execute(TimeTableTool.mGoogleSpreadSheetUrl);
    }
    ...
    class DBDownloadTaskFab extends GoogleSheetTask {
        private Database mDatabase;
        private String[] columnFirstRow;
        ...
        public void onFinish(long result) {
            ...
            Snackbar.make(fabProgressCircle, "다시 로딩됩니다", Snackbar.LENGTH_LONG)
